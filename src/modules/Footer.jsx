        ...
        <div className="footer_nav">
          <ul className="footer__menu">
            <li className="footer__menu-item">
              <a className="footer__menu-link footer__menu-link_active" href="#">Чай</a>
            </li>
            <li className="footer__menu-item">
